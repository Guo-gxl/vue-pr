...
export default {
  ...
  methods: {
    ...
    getData() {
      this.$http
        .post("http://47.103.14.235:27499/find/1234/" + this.$route.params.id)
        .then(res => {
          console.log(
            res.data + "这是刚进来！！！！！！！！！！！！！！！！！！！！！！"
          );
    ...
    tolist() {
      ...
      //重要！！！！！！！！
      this.$http
        .post("http://47.103.14.235:27499/find/123/" + this.$route.params.id, {
        ...
        .then(res => {
          ...
          console.log(
            JSON.stringify(res.data.comments) + "这是转换成JSON格式的添加后的"
          );
